...
public interface Bowl
{
	...
	/**
	 * Initializes this {@code Bowl}. The owning player and the number of stones will be set for this {@code Bowl}.
	 * 
	 * @param owner
	...
	/**
	 * Sets the next {@code Bowl} for this {@code Bowl}. An exception is thrown if the next bowl is already set or when
	 * {@code nextBowl} is {@code null}.
	 * 
	 * @param nextBowl
	...
	/**
	 * Sets the opposite {@code Bowl} for this {@code Bowl}. An exception is thrown if the opposite bowl is already set
	...
	/**
	 * This method performs the action for this {@code Bowl} when a {@code Heap} is distributed across all {@code Bowl}
	 * s.
	 * 
	 * @param heap
	 *            The {@code Heap} that is distributed.
	 * @return {@code true} if the an other turn can be made, {@code false} otherwise.
	 */
	...
	/**
	 * Plays this {@code Bowl}. A play consist of letting the next {@code Bowl} recieve the heap of this {@code Bowl}.
	 * An exception is thrown is this {@code Bowl} is not playable.
	 * 
	 * @return {@code true} if the current {@code Player} can take an other turn, {@code false} otherwise.
	 * @throws IllegalArgumentException
	...
	/**
	 * Returns if this {@code Bowl} is playable. A {@code Bowl} is playable if it is not a {@code Kalaha} and has
	 * non-zero amount of stones.
	 * 
	 * @return {@code true} if this {@code Bowl} is playable, {@code false} othwise.
	 */
