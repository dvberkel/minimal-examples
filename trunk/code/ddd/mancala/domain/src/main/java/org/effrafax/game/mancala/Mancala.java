...
public class Mancala implements Serializable {
	...
	/**
	 * Ends a turn for the current player. The opponent will become the current
	...
	/**
	 * Returns the start {@code Bowl} of chain owned by the current {@code
	 * Player}.
	 * 
	 ...
	 *            The number of skips to perform from the start {@code Bowl}.
	 * @throws IllegalArgumentException
	 *             if the {@code Bowl} after {@code index} skips is not
	 *             playable.
	 */
